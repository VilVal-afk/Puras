...
public class ErrorWithNoValue {
    ...
    public void checkingIntegerOperation() throws InterruptedException {
        ...
        calcPage.inputAndClick(driver, calcPage.calcInput, "s");
        Assert.assertEquals(calcPage.saved.getText(), "sin() =");
        Assert.assertEquals(calcPage.result.getText(), "Error");
    }
